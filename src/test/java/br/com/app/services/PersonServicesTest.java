...
class PersonServicesTest {
    ...
    void findAllWithMethod() {
        ...
        //testPersonData(1, people);
        //testPersonData(4, people);
        //testPersonData(7, people);
        testPersonData(8, people);
        testPersonData(9, people);

    }

    void testPersonData(int id, List<PersonDTO> people){
